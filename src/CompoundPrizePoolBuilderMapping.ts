...
import { CompoundPrizePoolBuilderPrizePoolCreatedEvent } from "../generated/schema"
import {
...
export function handlePrizePoolCreatedEvent(
  ...
  let entity = new CompoundPrizePoolBuilderPrizePoolCreatedEvent(
...
export function handlecreateCompoundPrizePoolCall(
  ...
  let entity = new CompoundPrizePoolBuildercreateCompoundPrizePoolCall(id)
...
export function handlecreateSingleRandomWinnerCall(
  ...
  let id = call.transaction.hash.toHex()
  let entity = new CompoundPrizePoolBuildercreateSingleRandomWinnerCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
