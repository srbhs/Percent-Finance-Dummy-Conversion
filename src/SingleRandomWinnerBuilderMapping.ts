...
import { SingleRandomWinnerBuilderSingleRandomWinnerCreatedEvent } from "../generated/schema"
import { SingleRandomWinnerBuildercreateSingleRandomWinnerCall } from "../generated/schema"

export function handleSingleRandomWinnerCreatedEvent(
  event: SingleRandomWinnerCreatedEvent
): void {
  let entity = new SingleRandomWinnerBuilderSingleRandomWinnerCreatedEvent(
...
export function handlecreateSingleRandomWinnerCall(
  ...
  let entity = new SingleRandomWinnerBuildercreateSingleRandomWinnerCall(id)
