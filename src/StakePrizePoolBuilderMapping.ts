...
import { StakePrizePoolBuilderPrizePoolCreatedEvent } from "../generated/schema"
import {
...
export function handlePrizePoolCreatedEvent(
  ...
  let entity = new StakePrizePoolBuilderPrizePoolCreatedEvent(
...
export function handlecreateSingleRandomWinnerCall(
  ...
  let entity = new StakePrizePoolBuildercreateSingleRandomWinnerCall(id)
...
export function handlecreateStakePrizePoolCall(
  ...
  let id = call.transaction.hash.toHex()
  let entity = new StakePrizePoolBuildercreateStakePrizePoolCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
