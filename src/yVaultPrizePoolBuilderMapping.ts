...
import { yVaultPrizePoolBuilderPrizePoolCreatedEvent } from "../generated/schema"
import {
...
export function handlePrizePoolCreatedEvent(
  ...
  let entity = new yVaultPrizePoolBuilderPrizePoolCreatedEvent(
...
export function handlecreateSingleRandomWinnerCall(
  ...
  let entity = new yVaultPrizePoolBuildercreateSingleRandomWinnerCall(id)
...
export function handlecreateyVaultPrizePoolCall(
  ...
  let id = call.transaction.hash.toHex()
  let entity = new yVaultPrizePoolBuildercreateyVaultPrizePoolCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
